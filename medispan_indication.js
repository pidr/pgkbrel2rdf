...
var turtle_dir = "./rdf/";
var medispanEventsPath = "./medispan_indication.csv";
var options = { //Options for the csv parser
  ...
  var  parser = csv(options);
    ...
    parser.on('finish', function() {
      writer.end(function (error, result) {
        writeToFile(result, "medispan_indication.ttl");
      });
    });
  fstream.pipe(parser);
  ...
  function getData(row) {
        ...
        writer.addTriple({
          subject:   'http://orpailleur.fr/medispan/'+indication,
          predicate: 'http://www.w3.org/1999/02/22-rdf-syntax-ns#type',
        ...
        writer.addTriple({
          subject:   'http://orpailleur.fr/medispan/'+drug,
          predicate: 'http://orpailleur.fr/medispan/indication',
          object:    'http://orpailleur.fr/medispan/'+indication
        });
